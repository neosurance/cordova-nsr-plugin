...
CF.code = function(params) {
	var code = (this.consonants(params.lastname) + this.vowels(params.lastname) + 'XXX').substr(0, 3);
	var s = this.consonants(params.firstname);
	if (s.length >= 4)
		code += s[0] + s[2] + s[3];
	else
		code += (s + this.vowels(params.firstname) + 'XXX').substr(0, 3);
