var WF_Delegate = {
	...
	//***** CORDOVA_WEB_VIEW -> Native Android App

	//NSR_AppLogin(final CordovaArgs args, final CallbackContext callbackContext)
	executeLogin: function(){
		exec(win, fail, service, "NSR_AppLogin", []);
	},

	//NSR_AppPayment(final CordovaArgs args, final CallbackContext callbackContext)
	executePayment: function(){
		exec(win, fail, service, "NSR_AppPayment", []);
	},
	...
	NSR_Setup: function (obj, win, fail) {
		...
		exec(win, fail, service, "start_sdk_main_activity", [obj]); //nsr_setup
